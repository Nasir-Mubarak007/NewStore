    ...
    <div className="max-w-2xl mx-auto mt-10 min-h-[55vh]">
      {!cart || !cart.items ? (
        <div className="flex min-h-[25rem] flex-col items-center justify-center rounded-lg border border-dashed p-8 text-center mt-20">
          ...
          <p className="mt-2 text-center text-sm leading-6 text-muted-foreground max-w-sm mx-auto mb-8">
            You currently don&apos;t have any product in your shopping cart.
            Please add some so that you can see them here.
          </p>
